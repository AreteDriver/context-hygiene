"""Local-only telemetry for context-hygiene usage tracking.

Opt-in via CONTEXT_HYGIENE_TELEMETRY=1 environment variable.
...
_ENV_VAR = "CONTEXT_HYGIENE_TELEMETRY"
...
def _get_store() -> TelemetryStore | None:
    ...
    if _store_instance is None:
        from context_hygiene.config import get_config_dir
